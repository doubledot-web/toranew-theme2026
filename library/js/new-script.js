...
function CheckBanner() {
    ...
    const timestamp = page_storage.getItem('seen-timestamp') ? page_storage.getItem('seen-timestamp') : null;
    const topBannerFrequencySee = Number(topBannerUpHolder.getAttribute('frequency'));
...
let firstNavElement = document.querySelector('.first-menu-item').firstElementChild;
...
setTimeout(() => {
    ...
    mobMenuIcon.addEventListener('click', () => {
        let slickNav = document.querySelector('.slicknav_nav').firstElementChild;
...
jQuery('#startStopMS1').on('click', function(){
    ...
    if( ! jQuery(this).hasClass('paused') ) {
        ...
        jQuery('.btn-customized-mini1 i').removeClass('fa-pause').addClass('fa-play');
        jQuery(this).blur();
    }
    else {
        ...
        crsl.carousel('cycle');
        jQuery('.btn-customized-mini1').toggleClass('paused');
        jQuery('.btn-customized-mini1 i').removeClass('fa-play').addClass('fa-pause');
        jQuery(this).blur();
    }
...
jQuery('#startStopMS2').on('click', function(){
    ...
    if( ! jQuery(this).hasClass('paused') ) {
        ...
        jQuery('.btn-customized-mini2 i').removeClass('fa-pause').addClass('fa-play');
        jQuery(this).blur();
    }
    else {
        // jQuery('#carousel').carousel('cycle');
        crsl.carousel('cycle');
        jQuery('.btn-customized-mini2').toggleClass('paused');
        jQuery('.btn-customized-mini2 i').removeClass('fa-play').addClass('fa-pause');
        jQuery(this).blur();
    }
...
jQuery('#startStopMS3').on('click', function(){
    ...
    if( ! jQuery(this).hasClass('paused') ) {
        ...
        jQuery('.btn-customized-mini3 i').removeClass('fa-pause').addClass('fa-play');
        jQuery(this).blur();
    }
    else {
        // jQuery('#carousel').carousel('cycle');
        crsl.carousel('cycle');
        jQuery('.btn-customized-mini3').toggleClass('paused');
        jQuery('.btn-customized-mini3 i').removeClass('fa-play').addClass('fa-pause');
        jQuery(this).blur();
    }
...
jQuery('#startStopMidi').on('click', function(){
    ...
    if( ! jQuery(this).hasClass('paused') ) {
        ...
        jQuery('.btn-customized-midi i').removeClass('fa-pause').addClass('fa-play');
        jQuery(this).blur();
    }
    else {
        // jQuery('#carousel').carousel('cycle');
        crsl.carousel('cycle');
        jQuery('.btn-customized-midi').toggleClass('paused');
        jQuery('.btn-customized-midi i').removeClass('fa-play').addClass('fa-pause');
        jQuery(this).blur();
    }
